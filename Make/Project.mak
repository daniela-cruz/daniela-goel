...
CFLAGS     = -ansi -pedantic-errors -Wall -fPIC $(CFG_FLAGS) $(PROJ_CFLAGS)
CPPFLAGS   = -ansi -pedantic-errors -Wall -fPIC -Wold-style-cast $(CFG_FLAGS) $(PROJ_CFLAGS)
...
$(BIN_DIR)/$(basename $(PROJ_OUT)).out: $(PROJ_OBJS) $(PROJ_OTHER_OBJS)
	...
	$(ECHO_FLAG)$(LD) $(PROJ_OBJS) $(PROJ_OTHER_OBJS) -Wl,-rpath=$(BIN_DIR) $(LDFLAGS) $(PROJ_LIBS:%=-l%) -o $(@)
	$(ECHO_FLAG)ln -f -s $(@) $(basename $(PROJ_OUT)).$(CONFIG).out
...
clean: $(PROJ_DEPENDS)
	...
	$(ECHO_FLAG)rm -f $(PROJ_OBJS) $(PROJ_OBJS_C:.o=.d) $(PROJ_OBJS_CPP:.obj=.d) $(BIN_DIR)/$(PROJ_OUT)
